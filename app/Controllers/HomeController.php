...
class HomeController extends BaseController
{
    ...
    public function __construct(Container $container, private TCGApiService $tcgapi, private CardsModel $cardsModel)
    {
    ...
    public function apiTest(Request $request, Response $response, array $args): Response
    {
        $this->cardsModel->populateOnePieceBluePrints();
        return $this->render($response, 'homeView.php');
    }

    public function setImport(Request $request, Response $response, array $args): Response
    {
        $this->cardsModel->importMTGSets();
        return $this->render($response, 'homeView.php');
    }
